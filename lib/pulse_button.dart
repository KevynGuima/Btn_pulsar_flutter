...
class _PulseButtonState extends State<PulseButton> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    if(widget.temperatura > 43 && _animationController.duration?.inMilliseconds == 600) {
      _animationController.stop();
      _animationController.duration = const Duration(milliseconds: 200);
      _animationController.repeat(reverse:true); 
    } else if (widget.temperatura > 37 && widget.temperatura < 47 && _animationController.duration?.inMicroseconds == 200) {
      _animationController.stop();
